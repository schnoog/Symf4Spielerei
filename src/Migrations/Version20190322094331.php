 ...
 */
final class Version20190322094331 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE paesse (id INT AUTO_INCREMENT NOT NULL, typ_id INT NOT NULL, landes_region_id INT NOT NULL, kategorie_id INT NOT NULL, belag_id INT DEFAULT NULL, status_id INT NOT NULL, von_richtung_id INT DEFAULT NULL, nach_richtung_id INT DEFAULT NULL, schwierigkeit_id INT NOT NULL, fahrbahnbreite_id INT DEFAULT NULL, wintersperre_id INT DEFAULT NULL, laenderkategorie_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, land VARCHAR(5) NOT NULL, lk VARCHAR(5) NOT NULL, hoehe INT NOT NULL, ausbauart VARCHAR(255) DEFAULT NULL, von_ort VARCHAR(255) DEFAULT NULL, von_hoehe INT DEFAULT NULL, von_distanz NUMERIC(4, 1) DEFAULT NULL, kehren INT NOT NULL, nach_ort VARCHAR(255) DEFAULT NULL, nach_hoehe INT DEFAULT NULL, nach_distanz NUMERIC(4, 1) DEFAULT NULL, maut TEXT DEFAULT NULL, besonderes TEXT DEFAULT NULL, sehenswuerdigkeit TEXT DEFAULT NULL, fototip VARCHAR(255) DEFAULT NULL, geo_lat NUMERIC(11, 8) NOT NULL, geo_lon NUMERIC(11, 8) NOT NULL, alte_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_7D379C4556310A12 (alte_id), INDEX IDX_7D379C45278CD074 (typ_id), INDEX IDX_7D379C45E11006A4 (landes_region_id), INDEX IDX_7D379C45BAF991D3 (kategorie_id), INDEX IDX_7D379C45CAF759A9 (belag_id), INDEX IDX_7D379C456BF700BD (status_id), INDEX IDX_7D379C4524A195EC (von_richtung_id), INDEX IDX_7D379C45537978D7 (nach_richtung_id), INDEX IDX_7D379C45458897DF (schwierigkeit_id), INDEX IDX_7D379C457FFA0EE (fahrbahnbreite_id), INDEX IDX_7D379C458493AC36 (wintersperre_id), INDEX IDX_7D379C451CE4A29C (laenderkategorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE paesse ADD CONSTRAINT FK_7D379C45CAF759A9 FOREIGN KEY (belag_id) REFERENCES belaege (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE paesse DROP FOREIGN KEY FK_7D379C45CAF759A9');

 ...
 */
final class Version20190320063945 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE ausbauarten (id INT AUTO_INCREMENT NOT NULL, ausbauart VARCHAR(50) NOT NULL, UNIQUE INDEX UNIQ_436F10E62ADA7B4F (ausbauart), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE laenderkategrien (id INT AUTO_INCREMENT NOT NULL, laenderkategrie_kurz VARCHAR(3) NOT NULL, laenderkategrie VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_10D6B1C6F3AE40C5 (laenderkategrie_kurz), UNIQUE INDEX UNIQ_10D6B1C63A1ECD2 (laenderkategrie), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE paesse (id INT AUTO_INCREMENT NOT NULL, typ_id INT NOT NULL, landes_region_id INT NOT NULL, kategorie_id INT NOT NULL, ausbauart_id INT NOT NULL, status_id INT NOT NULL, von_richtung_id INT DEFAULT NULL, nach_richtung_id INT DEFAULT NULL, schwierigkeit_id INT NOT NULL, fahrbahnbreite_id INT DEFAULT NULL, wintersperre_id INT DEFAULT NULL, laenderkategorie_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, hoehe DOUBLE PRECISION NOT NULL, von_ort VARCHAR(255) DEFAULT NULL, von_hoehe DOUBLE PRECISION NOT NULL, von_distanz DOUBLE PRECISION DEFAULT NULL, von_kehren INT NOT NULL, nach_ort VARCHAR(255) DEFAULT NULL, nach_hoehe DOUBLE PRECISION NOT NULL, nach_distanz DOUBLE PRECISION DEFAULT NULL, nach_kehren INT NOT NULL, maut TEXT DEFAULT NULL, besonderes TEXT DEFAULT NULL, sehenswuerdigkeit TEXT DEFAULT NULL, fototip VARCHAR(255) DEFAULT NULL, geo_lat DOUBLE PRECISION NOT NULL, geo_lon DOUBLE PRECISION NOT NULL, alte_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_7D379C455E237E06 (name), UNIQUE INDEX UNIQ_7D379C4556310A12 (alte_id), INDEX IDX_7D379C45278CD074 (typ_id), INDEX IDX_7D379C45E11006A4 (landes_region_id), INDEX IDX_7D379C45BAF991D3 (kategorie_id), INDEX IDX_7D379C45B74A9410 (ausbauart_id), INDEX IDX_7D379C456BF700BD (status_id), INDEX IDX_7D379C4524A195EC (von_richtung_id), INDEX IDX_7D379C45537978D7 (nach_richtung_id), INDEX IDX_7D379C45458897DF (schwierigkeit_id), INDEX IDX_7D379C457FFA0EE (fahrbahnbreite_id), INDEX IDX_7D379C458493AC36 (wintersperre_id), INDEX IDX_7D379C451CE4A29C (laenderkategorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE regionen (id INT AUTO_INCREMENT NOT NULL, land_id INT NOT NULL, region VARCHAR(255) NOT NULL, INDEX IDX_4086D2DA1994904A (land_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE paesse ADD CONSTRAINT FK_7D379C45B74A9410 FOREIGN KEY (ausbauart_id) REFERENCES ausbauarten (id)');
        ...
        $this->addSql('ALTER TABLE paesse ADD CONSTRAINT FK_7D379C451CE4A29C FOREIGN KEY (laenderkategorie_id) REFERENCES laenderkategrien (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE paesse DROP FOREIGN KEY FK_7D379C45B74A9410');
        ...
        $this->addSql('DROP TABLE ausbauarten');
        ...
        $this->addSql('DROP TABLE laenderkategrien');

 ...
 */
final class Version20190320161236 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE regionen (id INT AUTO_INCREMENT NOT NULL, land_id INT DEFAULT NULL, region VARCHAR(255) NOT NULL, INDEX IDX_4086D2DA1994904A (land_id), UNIQUE INDEX UniqueCountryRegion (land_id, region), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
